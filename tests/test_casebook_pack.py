"""Regression checks for the zenith-parse-regex-stack casebook."""
...
from casebook.harness import assert_expected, zenith_parse_regex_stack_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(zenith_parse_regex_stack_summary(), assert_expected())
